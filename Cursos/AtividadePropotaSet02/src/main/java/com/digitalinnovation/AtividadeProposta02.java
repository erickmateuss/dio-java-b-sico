...
class ComparatorAnoDeCriacaoENome implements  Comparator<LinguagemFavorita> {
    @Override
    public int compare(LinguagemFavorita l1f, LinguagemFavorita lf2) {
        int anoDeCriacao = Integer.compare(l1f.anoDeCriacao, lf2.anoDeCriacao);
        if (anoDeCriacao != 0) return anoDeCriacao;
        return l1f.nome.compareToIgnoreCase(lf2.nome);
    }
}
